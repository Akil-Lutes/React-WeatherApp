        ...
        <div className="flex justify-center border-2 border-yellow-600 p-8">
            <div className="bg-gray-600 flex items-center rounded-full shawdow-xl border-2 border-green-400 w-4/12">
                ...
                <div className="p-4 border-2 border-purple-600">
                    ...
                    <button className="bg-green-600 text-white rounded-full p-2 hover:bg-blue-400 focus:outline-none w-12 h-12 flex items-center justify-center" onClick={handleClick}>
                        Location
                    </button>
                </div>
            </div>
